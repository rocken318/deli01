...
export default async function BookingPage({
  ...
  const labels: BookingLabels = {
    ...
    destArea: label(ctx, "booking_dest_area"),
    hotelSelect: label(ctx, "booking_hotel_select"),
    hotelSearch: label(ctx, "booking_hotel_search"),
    areaHeading: label(ctx, "slots_area_heading"),
    areaRoughHeading: label(ctx, "booking_area_rough_heading"),
    areaAll: label(ctx, "slots_area_all"),
    phoneConfirmNote: label(ctx, "booking_phone_confirm_note"),
    addressPending: label(ctx, "booking_address_pending"),
