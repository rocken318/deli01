...
const publicSiteSettings: { key: string; value: unknown }[] = [
  ...
  },
  {
    ...
    value: {
      ...
      booking_dest_area: "エリアのみ（未定）",
      booking_hotel_select: "ホテルを選ぶ",
      booking_hotel_search: "ホテル名で検索（一部でも可）",
      booking_area_rough_heading: "大体のエリア",
      booking_phone_confirm_note: "ご予約後、必ずお電話で確認・確定いたします。ご住所・時間などの最終調整はそこで承ります。",
      booking_address_pending: "エリアのみ（詳細はお電話で確定）",
      ...
      booking_address_hotel_label: "派遣先ホテル・部屋番号",
      ...
      // 会員ページ ログイン（電話番号＋暗証番号 / 発注者決定 2026-09-06）
      member_title: "会員ページ",
      member_lead: "電話番号と暗証番号でログインすると、ポイントや履歴を確認できます。",
      member_phone_label: "電話番号（ハイフンなし）",
      member_pin_label: "暗証番号（数字4〜6桁）",
      member_login_cta: "ログイン",
      member_loading: "確認中…",
      member_error_bad: "電話番号または暗証番号が違います。",
      member_error_locked: "試行が続いたため一時的にロックされています。しばらくしてからお試しください。",
      member_error_invalid: "入力内容をご確認ください。",
      member_note: "暗証番号はお店で発行・変更できます。分からない場合はお問い合わせください。",
      member_link: "会員ページ（ポイント確認）",
